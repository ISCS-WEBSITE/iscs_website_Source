...
const Banner1Data4 = {
  ...
  subtitle:
    "An innovative e-Learning platform created in collaboration with leading educationists from prominent universities. This interactive online portal features a comprehensive repository of multinational-level competitive exam papers, providing students with the tools they need to excel in various competitive exams. With its stunning user interface designed for optimal viewing and readability, OGcom-eLP covers a broad range of subjects, including Mathematics, Physics, and Chemistry, and offers a diverse selection of competitive exams from multiple organizations across different countries.",
  link: "#",
};
