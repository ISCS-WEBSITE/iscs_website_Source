                ...
                <div className="relative bg-background p-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col h-full justify-between">
                      ...
                      <Link
                        href="https://iscs-website-test.vercel.app/#contact"
                        passHref
                      >
      ...
      <AnimatePresence>
        ...
        {dropdown && isOpen && name !== "Industries" && name !== "Services" && (
          ...
          >
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div
                className={`relative bg-background px-5 py-6 sm:gap-8 sm:p-8 ${
                  hasFeatureCard || hasTwoColumns
              ...
              >
                <div
                  className={
                    hasTwoColumns
                      ? "col-span-2 grid grid-cols-2 gap-x-8 gap-y-4"
                      : ""
                  }
                >
                  {dropdown.map((category, index) => (
      ...
      dropdown: [
        {
          ...
          items: [
            {
              name: "AI Strategy",
              description: "Develop AI-driven solutions",
              icon: "/assets/ai/ai-strategy.png",
              href: "/Services/AI-ML#ai-strategy",
            },
            {
              name: "Machine Learning Models",
              description: "Build and deploy ML models",
              icon: "/assets/ai/ml-models.png",
              href: "/Services/AI-ML#ml-models",
            },
          ],
        },
          ...
          items: [
            {
              ...
              description: "Expert integration planning",
              icon: "/assets/tibco/tibco-integration.png",
              href: "/Services/TIBCO#tibco-integration",
            },
            ...
            {
              name: "TIBCO Consulting",
              description: "Expert TIBCO consulting",
              icon: "/assets/tibco/tibco-support.png",
              href: "/Services/TIBCO#tibco-consulting",
            },
          ],
        },
          ...
          items: [
            {
              ...
              icon: "/assets/Cloud-Services/internet-cloud-computing.png",
              href: "/Services/Cloud-Services#cloud-solutions",
            },
            {
              name: "Cloud Migration Services",
              description: "Migration and Modernization ",
              icon: "/assets/Cloud-Services/cloud-migration.png",
          ...
          items: [
            {
              ...
              icon: "/assets/salesforce/salesforce-implementation.png",
              href: "/Services/Salesforce#salesforce-crm",
            },
            {
              name: "Service Cloud",
              description: "Salesforce Service Cloud ",
              icon: "/assets/salesforce/service-cloud.png",
              href: "/Services/Salesforce#salesforce-servicecloud",
            },
          ],
        },
          ...
          items: [
            {
              ...
              description: "Solutions for Oracle",
              icon: "/assets/Oracle/oracle-ebs.png",
              href: "/Services/Oracle#oracle-e-business",
            },
            {
              name: "Oracle Fusion Cloud",
              description: "Intelligent Business Insights",
              icon: "/assets/Oracle/oracle-fusion-cloud.png",
              href: "/Services/Oracle#oracle-fusion-cloud",
            },
          ],
        },
...

    {
      ...
      dropdown: [
...

        {
          ...
          items: [
            {
              name: "Empowering Learning",
              description: "Interactive  online education.",
              icon: "/assets/E-Learning/E-Learning.png",
        ...
        },
        {
          ...
          items: [
            ...
            {
              name: "Low-Cost",
              description: "Efficient Integration Solutions",
              icon: "/assets/Mi-Ware/Mi-Ware.png",
              href: "/Products/Mi-ware#mi-ware",
            },
          ],
        },
      ],
          ...
          items: [
            {
              ...
              icon: "/assets/Industries/banking.png",
              href: "/Industries",
            },
            {
              name: "Communication Technologies",
              icon: "/assets/Industries/communication.png",
              href: "/Industries",
            },
            {
              name: "High-Tech & Semiconductor",
              icon: "/assets/Industries/semiconductor.png",
              href: "/Industries",
            },
            {
              name: "Education",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: "/assets/Industries/trading.png",
              href: "/Industries",
            },
            {
              name: "Industrial Manufacturing",
              icon: "/assets/Industries/industry.png",
              href: "/Industries",
            },
          ],
        },
        ...
        <div className="flex justify-between h-[80px]">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              ...
              onClick={(e) => {
                e.preventDefault();
                window.location.href = "/Home"; // triggers full reload
              }}
            >
              <Button
                variant="ghost"
